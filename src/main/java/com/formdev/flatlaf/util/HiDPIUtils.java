...
public class HiDPIUtils {
    ...
    public static void paintAtScale1x(Graphics2D g, int x, int y, int width, int height, Painter painter) {
        ...
        double scaleX = t2.getScaleX();
        double scaleY = t2.getScaleY();
        double shearX = t2.getShearX();
        double shearY = t2.getShearY();
        ...
        double px = (double)x * scaleX + (double)y * shearX + t2.getTranslateX();
        double py = (double)y * scaleY + (double)x * shearY + t2.getTranslateY();
