...
public class JBRCustomDecorations {
    ...
    static boolean hasCustomDecoration(Window window) {
        ...
        try {
            return (Boolean)Window_hasCustomDecoration.invoke((Object)window, new Object[0]);
}
        catch (Exception ex) {
    ...
    static void setHasCustomDecoration(Window window, boolean hasCustomDecoration) {
        ...
        try {
            if (hasCustomDecoration) {
                Window_setHasCustomDecoration.invoke((Object)window, new Object[0]);
            } else {
    ...
    extends BorderUIResource.EmptyBorderUIResource {
        ...
        private Color calculateActiveBorderColor() {
            ...
            if (colorizationColor != null) {
                ...
                int r2 = Math.round((float)colorizationColor.getRed() * alpha + 217.0f * remainder);
