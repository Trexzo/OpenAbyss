...
implements FlatStylingSupport.StyleableUI {
    ...
    PropertyChangeListener {
        ...
        public void layoutContainer(Container parent) {
            ...
            Insets insets = parent.getInsets();
            Rectangle r2 = FlatUIUtils.subtractInsets(new Rectangle(size), insets);
            if (this.nextButton == null && this.previousButton == null) {
                if (this.editor != null) {
                    this.editor.setBounds(r2);
}
                return;
}
            Rectangle editorRect = new Rectangle(r2);
            Rectangle buttonsRect = new Rectangle(r2);
