...
ComponentListener {
    ...
    MouseMotionListener {
        ...
        public void mouseMoved(MouseEvent e) {
            ...
            int n2 = wh = topOrBottom ? this.getWidth() : this.getHeight();
    ...
    extends FlatWindowResizer {
        ...
        @Override
        protected void setWindowBounds(Rectangle r2) {
            this.desktopManager.get().resizeFrame(this.getFrame(), r2.x, r2.y, r2.width, r2.height);
}
        @Override
