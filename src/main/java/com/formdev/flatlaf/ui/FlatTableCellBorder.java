...
extends FlatLineBorder {
    ...
    public Insets getBorderInsets(Component c, Insets insets) {
        Insets m2 = FlatTableCellBorder.getStyleFromTableUI(c, ui -> ui.cellMargins);
        if (m2 != null) {
            return FlatTableCellBorder.scaleInsets(c, insets, m2.top, m2.left, m2.bottom, m2.right);
}
