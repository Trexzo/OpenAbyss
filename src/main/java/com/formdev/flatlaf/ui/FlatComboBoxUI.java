...
FlatStylingSupport.StyleableLookupProvider {
    ...
    protected PropertyChangeListener createPropertyChangeListener() {
        ...
        return e -> {
            ...
            if (this.editor != null && (source == this.comboBox && propertyName == "foreground" || source == this.editor && propertyName == "enabled")) {
                ...
                ComponentOrientation o2 = (ComponentOrientation)e.getNewValue();
                this.editor.applyComponentOrientation(o2);
            } else {
                switch (propertyName) {
    ...
    extends BasicComboPopup {
        protected FlatComboPopup(JComboBox combo) {
            super(combo);
            ComponentOrientation o2 = this.comboBox.getComponentOrientation();
            this.list.setComponentOrientation(o2);
            this.scroller.setComponentOrientation(o2);
            this.setComponentOrientation(o2);
}
        @Override
