...
public class EntityHooks {
    ...
    public static void onMoveFlying(Entity var0, float var1, float var2, float var3, CallbackInfo var4) {
        ...
        if ((var6 = var1 * var1 + var2 * var2) >= 1.0E-4f) {
            if ((var6 = MathHelper.sqrt_float((float)var6)) < 1.0f) {
                var6 = 1.0f;
}
            var6 = var3 / var6;
            float var7 = MathHelper.sin((float)(var5 * (float)Math.PI / 180.0f));
            float var8 = MathHelper.cos((float)(var5 * (float)Math.PI / 180.0f));
            var0.motionX += (double)((var1 *= var6) * var8 - (var2 *= var6) * var7);
            var0.motionZ += (double)(var2 * var8 + var1 * var7);
}
        var4.cancel();
}
    ...
    public static void setAngles(Entity var0, float var1, float var2, CallbackInfo var3) {
        if (var0 instanceof EntityPlayerSP) {
            ...
            if (var10.l()) {
                ...
                var0.prevRotationPitch += var0.rotationPitch - var11;
                var0.prevRotationYaw += var0.rotationYaw - var12;
                var3.cancel();
                return;
}
            if (var10.a()) {
    ...
    public static void getCollisionBorderSize(Entity var0, CallbackInfoReturnable<Float> var1) {
        if (ModuleManager.r.o() && var0 != null && var0.worldObj != null && var0 != EntityHooks.V.thePlayer && var0 instanceof EntityLivingBase && HitBox.k((byte)0, (EntityLivingBase)var0, 95546070903943L)) {
