...
implements EventSubscriber {
    ...
    public void onRender2D(long var1, Render2DEvent var3) {
        if (LeapModeHUD.f.field_71439_g != null && TeamPrefixUtil.i() && TeamPrefixUtil.F(22611545248530L, LeapModeHUD.f.field_71439_g.func_70005_c_()) == MegaWallsClass.SPIDER) {
            String var6 = "Leap Mode: " + this.h;
            float var7 = scale == null ? 1.0f : scale.L();
            float var8 = (float)var3.C.func_78326_a() / 2.0f + (offsetX == null ? 0.0f : offsetX.L());
            float var9 = (float)var3.C.func_78328_b() / 2.0f + (offsetY == null ? 0.0f : offsetY.L());
            int var10 = LeapModeHUD.f.field_71466_p.func_78256_a(var6);
            int var11 = LeapModeHUD.f.field_71466_p.field_78288_b;
            int var12 = backgroundOpacity == null ? 0 : backgroundOpacity.k() * 255 / 100;
            GlStateManager.func_179094_E();
            GlStateManager.func_179109_b((float)var8, (float)var9, (float)0.0f);
            GlStateManager.func_179152_a((float)var7, (float)var7, (float)1.0f);
            int var13 = -var10 / 2 - 4;
            int var14 = -var11 / 2 - 3;
            int var15 = var10 / 2 + 4;
            int var16 = var11 / 2 + 3;
            if (var12 > 0) {
                Gui.func_73734_a((int)var13, (int)var14, (int)var15, (int)var16, (int)new Color(0, 0, 0, var12).getRGB());
}
            LeapModeHUD.f.field_71466_p.func_175063_a(var6, (float)(-var10) / 2.0f, (float)(-var11) / 2.0f, 0xFFFFFF);
    ...
    public void onReceivePacket(long var1, ReceivePacketEvent var3) throws UnsupportedEncodingException, InvalidAlgorithmParameterException, InvalidKeyException, InvalidKeySpecException, BadPaddingException, IllegalBlockSizeException {
        String var4;
        if (var3.d instanceof S02PacketChat && (var4 = ((S02PacketChat)var3.d).func_148915_c().func_150260_c()) != null) {
