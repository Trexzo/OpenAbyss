...
public class RaytraceUtilSwitchMapEnumFacing {
    ...
    static {
        try {
            ...
            long var17 = ((long)var6[0] & 0xFFL) << 56 | ((long)var6[1] & 0xFFL) << 48 | ((long)var6[2] & 0xFFL) << 40 | ((long)var6[3] & 0xFFL) << 32 | ((long)var6[4] & 0xFFL) << 24 | ((long)var6[5] & 0xFFL) << 16 | ((long)var6[6] & 0xFFL) << 8 | (long)var6[7] & 0xFFL;
            int var10001 = -1;
            long var0 = var17;
            b = new int[EnumFacing.values().length];
            try {
                RaytraceUtilSwitchMapEnumFacing.b[EnumFacing.WEST.ordinal()] = 1;
}
            catch (NoSuchFieldError noSuchFieldError) {
                // empty catch block
}
            try {
                RaytraceUtilSwitchMapEnumFacing.b[EnumFacing.EAST.ordinal()] = 2;
}
            catch (NoSuchFieldError noSuchFieldError) {
                // empty catch block
}
            try {
                RaytraceUtilSwitchMapEnumFacing.b[EnumFacing.NORTH.ordinal()] = 3;
}
            catch (NoSuchFieldError noSuchFieldError) {
                // empty catch block
}
            try {
                RaytraceUtilSwitchMapEnumFacing.b[EnumFacing.SOUTH.ordinal()] = 4;
}
            catch (NoSuchFieldError noSuchFieldError) {
                // empty catch block
}
            try {
                RaytraceUtilSwitchMapEnumFacing.b[EnumFacing.UP.ordinal()] = 5;
}
            catch (NoSuchFieldError noSuchFieldError) {
                // empty catch block
}
            try {
                RaytraceUtilSwitchMapEnumFacing.b[EnumFacing.DOWN.ordinal()] = (int)var0;
}
            catch (NoSuchFieldError noSuchFieldError) {}
}
