...
public class DracuRiotMainMenu {
    private static long private static final float v = 1.7777778f;
    ...
    private static int R(String[] var0, float var4) {
        ...
        for (String var11 : var0) {
            int var12 = (int)((float)DracuRiotMainMenu.T.field_71466_p.func_78256_a(var11) * var4);
    ...
    public static void h(int var0, int var1) {
        T.func_110434_K().func_110577_a(MainMenuTheme.z);
        int var2 = var0;
        ...
        Gui.func_146110_a((int)var4, (int)var5, (float)0.0f, (float)0.0f, (int)var2, (int)var3, (float)var2, (float)var3);
}
    public static void D(int var0, int var1, long var2, List var4) {
        ...
        int[] var10 = var10000;
        String[] var21 = new String[]{I18n.func_135052_a((String)"menu.singleplayer", (Object[])new Object[0]), I18n.func_135052_a((String)"menu.multiplayer", (Object[])new Object[0]), I18n.func_135052_a((String)"menu.online", (Object[])new Object[0]).replace("Minecraft", "").trim(), "Alt Manager", I18n.func_135052_a((String)"fml.menu.mods", (Object[])new Object[0]), I18n.func_135052_a((String)"menu.options", (Object[])new Object[0]), I18n.func_135052_a((String)"menu.quit", (Object[])new Object[0])};
        String[] var11 = var21;
        float var12 = DracuRiotMainMenu.q(var1);
        int var13 = Math.max(12, (int)((float)DracuRiotMainMenu.T.field_71466_p.field_78288_b * var12));
    ...
    public static void u(int var0, int var1, long var2, List var4) {
        ...
        int var10 = var1 - 24;
        int var11 = Math.max(12, (int)((float)DracuRiotMainMenu.T.field_71466_p.field_78288_b * var8));
        ...
        int var15 = 0;
        for (GuiButton var17 : var4) {
            if (!(var17 instanceof DracuRiotMenuButton)) continue;
            ((DracuRiotMenuButton)var17).k(var8);
            var17.func_175211_a(var14);
            ((DracuRiotMenuButton)var17).U(var11);
            var17.field_146128_h = var9 - var14;
            var17.field_146129_i = var13 - var12 * (6 - var15);
            ++var15;
}
}
    private static int b(List var0, char var2, float var4) {
        int var7 = 0;
        for (GuiButton var9 : var0) {
            int var10;
            if (!(var9 instanceof DracuRiotMenuButton) || (var10 = (int)((float)DracuRiotMainMenu.T.field_71466_p.func_78256_a(var9.field_146126_j) * var4)) <= var7) continue;
            var7 = var10;
}
        return var7 + Math.max(8, (int)(4.0f * var4));
}
