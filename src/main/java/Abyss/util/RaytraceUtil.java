...
public class RaytraceUtil {
    ...
    private static double D(AxisAlignedBB var0, Vec3 var1, boolean var2, double var3) {
        ...
        double var23 = var1.yCoord <= var5 ? (var5 + var13) * 0.5 : MathUtil.R(var1.yCoord, (var5 + var13) * 0.5, var21);
    ...
    private static Vec3 U(AxisAlignedBB var0, long var1, Vec3 var3, double var4) {
        ...
        for (int var32 = 0; var32 < var33; ++var32) {
            ...
            if (var35 > var8 || RaytraceUtil.F.theWorld.rayTraceBlocks(var3, var34) != null) continue;
            double var37 = Math.abs(var34.yCoord - var24);
            double var39 = RaytraceUtil.d(var34.xCoord, var34.zCoord, var22, var26);
    ...
    public static double z(Vec3 var0) {
        return RaytraceUtil.f().distanceTo(var0);
}
    public static boolean H(Vec3 var0, double var1) {
        Vec3 var3 = RaytraceUtil.f();
        return var3.distanceTo(var0) > var1 ? true : RaytraceUtil.F.theWorld.rayTraceBlocks(var3, var0) != null;
}
    ...
    private static Vec3 S(BlockPos var0, EnumFacing var1) {
        return new Vec3((double)var0.getX() + 0.5 + (double)var1.getFrontOffsetX() * 0.5, (double)var0.getY() + 0.5 + (double)var1.getFrontOffsetY() * 0.5, (double)var0.getZ() + 0.5 + (double)var1.getFrontOffsetZ() * 0.5);
}
    public static MovingObjectPosition J(double var0) {
        Vec3 var2 = RaytraceUtil.f();
        Vec3 var3 = RaytraceUtil.F.thePlayer.getLookVec();
        Vec3 var4 = var2.addVector(var3.xCoord * var0, var3.yCoord * var0, var3.zCoord * var0);
        return RaytraceUtil.F.thePlayer.worldObj.rayTraceBlocks(var2, var4, false, false, false);
}
    public static MovingObjectPosition M() {
        return RaytraceUtil.f(RotationManager.r, RotationManager.G, RaytraceUtil.F.playerController.getBlockReachDistance(), 1.0f);
}
    ...
    public static Vec3 f() {
        return RaytraceUtil.F.thePlayer.getPositionEyes(1.0f);
}
    ...
    public static AxisAlignedBB J(BlockPos var0) {
        return new AxisAlignedBB((double)var0.getX(), (double)var0.getY(), (double)var0.getZ(), (double)(var0.getX() + 1), (double)(var0.getY() + 1), (double)(var0.getZ() + 1));
}
    ...
    private static Vec3 s(AxisAlignedBB var0, Vec3 var1, double var2) {
        ...
        boolean bl = var16 = var0.minX - 1.0 < var1.xCoord && var0.maxX + 1.0 > var1.xCoord && var0.minZ - 1.0 < var1.zCoord && var0.maxZ + 1.0 > var1.zCoord;
        if (var16) {
    ...
    public static EntityLivingBase Z(double var0) {
        Entity var2 = null;
        MovingObjectPosition var3 = RaytraceUtil.F.thePlayer.rayTrace(var0, 1.0f);
        Vec3 var4 = RaytraceUtil.f();
        float var5 = RotationManager.r;
        float var6 = RotationManager.G;
        float var7 = MathHelper.cos((float)(-var5 * ((float)Math.PI / 180) - (float)Math.PI));
        float var8 = MathHelper.sin((float)(-var5 * ((float)Math.PI / 180) - (float)Math.PI));
        float var9 = -MathHelper.cos((float)(-var6 * ((float)Math.PI / 180)));
        Vec3 var10 = new Vec3((double)(var8 * var9), (double)MathHelper.sin((float)(-var6 * ((float)Math.PI / 180))), (double)(var7 * var9));
        Vec3 var11 = var4.addVector(var10.xCoord * var0, var10.yCoord * var0, var10.zCoord * var0);
        Vec3 var12 = null;
        List var13 = RaytraceUtil.F.theWorld.getEntitiesWithinAABBExcludingEntity(F.getRenderViewEntity(), F.getRenderViewEntity().getEntityBoundingBox().addCoord(var10.xCoord * var0, var10.yCoord * var0, var10.zCoord * var0).expand(1.0, 1.0, 1.0));
        double var14 = var0;
        int var17 = var13.size();
        for (int var16 = 0; var16 < var17; ++var16) {
            double var21;
            Entity var18 = (Entity)var13.get(var16);
            if (!var18.canBeCollidedWith()) continue;
            ...
            if (var20 == null || !((var21 = var4.distanceTo(var20.hitVec)) < var14) && var14 != 0.0) continue;
            if (var18 != RaytraceUtil.F.getRenderViewEntity().ridingEntity || MethodAccessors.o(var18)) {
                var2 = var18;
                var12 = var20.hitVec;
                var14 = var21;
                continue;
        ...
        return var3 != null && var3.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY && var3.entityHit instanceof EntityLivingBase ? (EntityLivingBase)var3.entityHit : null;
}
    public static AxisAlignedBB S(Entity var0) {
        float var1 = var0.getCollisionBorderSize();
        return var0.getEntityBoundingBox().expand((double)var1, (double)var1, (double)var1);
}
    ...
    public static Vec3 R(Entity var0, long var1, double var3, boolean var5) {
        ...
        double var11 = var9.minY + (double)var0.getCollisionBorderSize() + (double)var0.getEyeHeight();
    ...
    private static Vec3 i(Vec3 var0, Vec3 var1, double var2) {
        return new Vec3(MathUtil.I(var0.xCoord, var1.xCoord, var2), MathUtil.I(var0.yCoord, var1.yCoord, var2), MathUtil.I(var0.zCoord, var1.zCoord, var2));
}
    ...
    public static MovingObjectPosition H(Vec3 var0) {
        return RaytraceUtil.F.theWorld.rayTraceBlocks(RaytraceUtil.f(), var0);
}
    ...
    private static Vec3 i(AxisAlignedBB var0, Vec3 var1, Vec3 var2) {
        boolean var3;
        boolean bl = var3 = var0.minX - 1.0 < var1.xCoord && var0.maxX + 1.0 > var1.xCoord && var0.minZ - 1.0 < var1.zCoord && var0.maxZ + 1.0 > var1.zCoord;
        if (var3) {
    ...
    private static boolean M(BlockPos var0, EnumFacing var1, Vec3 var2, Vec3 var3, double var4) {
        ...
        MovingObjectPosition var6 = RaytraceUtil.F.theWorld.rayTraceBlocks(var3, var2);
        return var6 != null && var6.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK && var0.equals((Object)var6.getBlockPos()) && var1 == var6.sideHit;
}
    ...
    private static Vec3 e(AxisAlignedBB var0, Vec3 var1) {
        ...
        return var2.distanceTo(var1) > 1.0E-6 ? var2 : new Vec3((var0.minX + var0.maxX) * 0.5, (var0.minY + var0.maxY) * 0.5, (var0.minZ + var0.maxZ) * 0.5);
}
    public static List<EntityLivingBase> j(double var0) {
        WorldClient var2 = RaytraceUtil.F.theWorld;
        ...
        float var8 = MathHelper.cos((float)(-var6 * ((float)Math.PI / 180) - (float)Math.PI));
        float var9 = MathHelper.sin((float)(-var6 * ((float)Math.PI / 180) - (float)Math.PI));
        float var10 = -MathHelper.cos((float)(-var7 * ((float)Math.PI / 180)));
        float var11 = MathHelper.sin((float)(-var7 * ((float)Math.PI / 180)));
        ...
        AxisAlignedBB var14 = var3.getEntityBoundingBox().addCoord(var12.xCoord * var0, var12.yCoord * var0, var12.zCoord * var0).expand(1.0, 1.0, 1.0);
        List var15 = var2.getEntitiesWithinAABBExcludingEntity(var3, var14);
        int var17 = var15.size();
        for (int var16 = 0; var16 < var17; ++var16) {
            Entity var18 = (Entity)var15.get(var16);
            if (!(var18 instanceof EntityLivingBase) || !var18.canBeCollidedWith()) continue;
            AxisAlignedBB var19 = RaytraceUtil.S(var18);
            MovingObjectPosition var20 = var19.calculateIntercept(var5, var13);
            if (!var19.isVecInside(var5) && var20 == null) continue;
    ...
    public static Vec3 h(Vec3 var0, AxisAlignedBB var1) {
        double var2 = MathHelper.clamp_double((double)var0.xCoord, (double)var1.minX, (double)var1.maxX);
        double var4 = MathHelper.clamp_double((double)var0.yCoord, (double)var1.minY, (double)var1.maxY);
        double var6 = MathHelper.clamp_double((double)var0.zCoord, (double)var1.minZ, (double)var1.maxZ);
    ...
    private static boolean g(Vec3 var0, Vec3 var1, double var2, boolean var4) {
        ...
        return var1.distanceTo(var0) > var2 ? false : !var4 || RaytraceUtil.F.theWorld.rayTraceBlocks(var1, var0) == null;
}
    ...
    public static MovingObjectPosition F(float var0, float var1) {
        return RaytraceUtil.f(var0, var1, RaytraceUtil.F.playerController.getBlockReachDistance(), 1.0f);
}
    ...
    private static Vec3 g(BlockPos var0, EnumFacing var1, long var2, Vec3 var4) {
        ...
        double var6 = (double)var0.getX() + 0.15;
        double var8 = (double)var0.getX() + 1.0 - 0.15;
        double var10 = (double)var0.getZ() + 0.15;
        double var12 = (double)var0.getZ() + 1.0 - 0.15;
        ...
        switch (RaytraceUtilSwitchMapEnumFacing.b[var1.ordinal()]) {
            ...
            case 2: {
                double var29;
                if (!(Math.abs(var16) > 1.0E-6) || !((var29 = (var5.xCoord - var4.xCoord) / var16) >= 0.0)) break;
            ...
            case 4: {
                double var28;
                if (!(Math.abs(var18) > 1.0E-6) || !((var28 = (var5.zCoord - var4.zCoord) / var18) >= 0.0)) break;
    ...
    private static Vec3 l(AxisAlignedBB var0, Vec3 var1) {
        return new Vec3(MathUtil.R(var1.xCoord, var0.minX, var0.maxX), MathUtil.R(var1.yCoord, var0.minY, var0.maxY), MathUtil.R(var1.zCoord, var0.minZ, var0.maxZ));
}
    ...
    private static Vec3 distanceTo(AxisAlignedBB var0, Vec3 var1, double var2, boolean var4, int var5, boolean var6, int var7, byte var8, double var9) {
        ...
        if (RaytraceUtil.g(var18, var1, var15, var4) && RaytraceUtil.g(var25 = RaytraceUtil.h(RaytraceUtil.i(var18, var17, var23 = MathUtil.R(0.35 + (var21 = 1.0 - MathUtil.R((var19 = var1.distanceTo(var18)) / var15, 0.0, 1.0)) * 0.5, 0.35, 0.85)), var0), var1, var15, var4)) {
            return var25;
}
    ...
    public static MovingObjectPosition A(long var0, Entity var2) {
        ...
        Vec3 var5 = RaytraceUtil.R(var2, var3, RaytraceUtil.F.playerController.getBlockReachDistance(), true);
